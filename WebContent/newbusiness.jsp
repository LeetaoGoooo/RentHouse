	...
	<div class="menu-right">
		 <ul class="menu">
			...
			<ul class="cute">
						...
						<li class="subitem3"><a  href="questionAction!getAllQuestion">问答</a></li>		</li>
		</ul>
	</div>
	<div class="clearfix"> </div>
		<!--initiate accordion-->
...
<!---->
<div class="single">
<form action="houseAction!searchAllBussines" method="post">
<div class="container">
				<div class="col-sm-2 price-top">
					<h4>城市</h4>
					      <select name="city" class="drop-select" >
...
<!-- 					    <li class="loan-list-top"> -->
					      <select name="size" class="drop-select">
							<option value = "100">200平米以下</option>
							<option value = "300">200-400平米</option>
							<option value = "500">400-600平米</option>
							<option value = "700">600-800平米</option>
							<option value = "900">800-1000平米</option>
		                    <option value = "1000">1000平米以上</option>    
				          </select>
<!-- 					    </li> -->
<!-- 		          </ul> -->
			</div>
      <div class="col-sm-2 price-top">
          <h4>价格</h4>
              <select name="price" class="drop-select">
                <option value = "500">1000元以下/月</option>
                <option value = "1500">1000-2000元/月</option>
                <option value = "2500">2000-3000元/月</option>
                <option value = "3000">3000元以上/月</option>
              </select>
        <div class="clearfix"> </div>
        <br/>
				<div class="sub1" align="center">
					<label class="hvr-sweep-to-right"><input type="submit" value="查询"></label>
				</div>
            <div class="clearfix"> </div>
      </div>
  </div>
	...
	<div class="buy-single">
		...
		<div class="box-sin">
			<div class="col-md-9 single-box">
				<s:iterator value="#session.BussinessList" var="bussiness">
					<div class="box-col">
						...
						<div class="  col-sm-5 middle-side">
						     ...
						     <p><span class="bath">Name </span>: <span class="two">${bussiness.title}</span></p>
						     <p>  <span class="bath1">Renttype </span>: <span class="two">${bussiness.renttype}</span></p>
						     <p><span class="bath2">Adress</span>: <span class="two">${bussiness.address}</span></p>
						     <p><span class="bath3">Plot Area </span>:<span class="two">${bussiness.size} m*m</span></p>
							 <p><span class="bath4">Age of property</span> : <span class="two">${bussiness.age} Years</span></p>
							 <p><span class="bath5">Price </span>:<span class="two">${bussiness.price} 元</span></p>				 
