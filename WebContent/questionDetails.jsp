...
<div class="privacy">
	<div class="container">
		...
		<p></p>
		<h4>${session.Question.title}</h4>
        <h5>发表问题的人: <a href="userAction!showPersonalInfo?name=${session.Question.getUser().getName()}">${session.Question.getUser().getName()}</a> | 时间 :${session.Question.publictime }</h5>
        <br/>
       
        <s:iterator value="#session.Answers" var="answer" status="st">
       	 <div class="media">
		    ...
		    <div class="media-body">
		    	<h4 class="media-heading">${answer.getUser().getName()}<h5>时间:${answer.getTime() } </h5></h4>
        ...
        <div class="leave">
			<h5>发表我的意见</h5>
			<s:form action="questionAction!AnswerQuesByQID" method="post">
			   <s:textarea  name="content" placeholder="回复" required=""/>
