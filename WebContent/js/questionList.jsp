			...
			<div class="container-fluid">
				<nav class="pull">
					<ul>
						...
						<li><a  href="newhouse.html">租房</a></li>
                        <li><a  href="newcom.html">小区</a></li>
						<li><a  href="newbusiness.html">商铺写字楼</a></li>
						<li><a  href="newVillage.html">别墅</a></li>
						<li><a  href="newluxury.html">豪华套房</a></li>
						<li><a  href="ques.html">问答</a></li>
					</ul>
				</nav>			
			</div>
		</div>
...
<div class=" banner-buying">
	...
	<div class="menu-right">
		 <ul class="menu">
			...
			<ul class="cute">
				<li class="subitem1"><a href="new.html">租房 </a></li>
				<li class="subitem2"><a href="rent.html">出租 </a></li>
				<li class="subitem1"><a href="newcom.html">小区</a></li>
				<li class="subitem2"><a href="newbusiness.html">商铺写字楼</a></li>
				<li class="subitem3"><a href="newvillage.html">别墅 </a></li>
				<li class="subitem3"><a href="newluxury.html">豪华套房 </a></li>
                <li class="subitem3"><a href="ques.html">问答</a></li>
			</ul>
		</li>
		</ul>
	</div>
...
<div class="asked">
	<div class="container">
		 <h3>问题列表</h3>
		 <s:iterator value="#session.Posts" var="question" status="st">
			<div class="questions">
				<h5><a style=" color:#01B468;" href="questionAction!getPostDetailById?id=${question.id}">${question.title}</a></h5>
			</div>							
		</s:iterator>	   		    
	</div>
</div>
