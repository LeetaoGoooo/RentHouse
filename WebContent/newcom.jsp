...
<!--Dealers-->
<div class="dealers">
<form action="houseAction!searchAllCom" method="post">
        <div class="price-grid">
          <div class="col-sm-2 price-top">
            ...
            <div class="col-sm-2 price-top">
                <h4>交通便利</h4>
                <select name="traffic" class="in-drop">
	...
	<div class="dealer">
		...
		<div class="dealer-top">
			<div class="deal-top-top">
				<s:iterator value="#session.ComList" var="com">
					<div class="col-md-3 top-deal-top">
						<div class=" top-deal">
							...
							<div class="deal-bottom">
								<div class="top-deal1">
									<h5><a href="single-house.html"></a></h5>
	                                <p>地址:${com.address}</p>
	                                <p>价格:${com.totalarea}*${com.cost}元</p>
								</div>
								<div class="top-deal2">
									<a href="houseAction!getComDetailsById?id=${com.id}" class="hvr-sweep-to-right more">More</a>
								</div>
							<div class="clearfix"> </div>
							</div>
						</div>
	...
	<div class="container">
		<div class="footer-top-at">
			<div class="col-md-3 amet-sed">
				<h4><a style=" color:White;" href="about.html">房产知识</a></h4>
				<ul class="nav-bottom">
			...
			<div class="col-md-3 amet-sed ">
				<h4><a style=" color:White;" href="single.html">房产法律</a></h4>
					<ul class="nav-bottom">
			...
			<div class="col-md-3 amet-sed">
				<h4><a style=" color:White;" href="#">房屋风水</a></h4>
				<p>Mon-Fri, 7AM-7PM </p>
				<p>Sat-Sun, 8AM-5PM </p>
				<p>177-869-6559</p>
					<ul class="nav-bottom">
			...
			<div class="col-md-3 amet-sed ">
				<h4><a style=" color:White;" href="single.html">装修设计</a></h4>
				   <ul class="nav-bottom">
