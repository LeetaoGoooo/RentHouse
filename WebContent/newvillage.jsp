	...
	<div class="menu-right">
		 <ul class="menu">
			...
			<ul class="cute">
						...
						<li class="subitem3"><a  href="getAllVillageHouse">别墅</a></li>
...
<div class="loan_single">
	<div class="container">
		<div class="loan-col">
		<form action="houseAction!searchAllVillage" method="post">
    		<h3>热门别墅</h3>
			...
			<div class="col-sm-3 price-top">
				<h4>面积</h4>
				<select class="in-drop" name="size">
					<option value="50">100平米以下</option>
					<option value="150">100-200平米</option>
            ...
            <div class="col-sm-3 price-top">
				...
				<select class="in-drop" name="price">
					...
					<option value="4500">4000-5000元</option>
                    <option value="5500">5000-6000元</option>
                    <option value="6000">6000以上元</option>                    
				</select>
			</div> 
            <div class="clearfix"> </div>
             <br/>
	...
	<div class="buy-single">
		...
		<div class="box-sin">
			<div class="col-md-9 single-box">
				<s:iterator value="#session.VillageList" var="village">
					<div class="box-col">
					...
					<div class="  col-sm-5 middle-side">
					     ...
					     <p><span class="bath">Layout </span>: <span class="two">${village.buju}</span></p>
					     <p>  <span class="bath1">Decoration </span>: <span class="two">${village.decoration}</span></p>
					     <p><span class="bath2">Address</span>: <span class="two">${village.address}</span></p>
					     <p><span class="bath3">RentType</span>:<span class="two">${village.renttype}</span></p>
						 <p><span class="bath4">Age of property</span> : <span class="two">${village.age}Years</span></p>
						 <p><span class="bath5">Price </span>:<span class="two">${village.price}</span></p>				 
