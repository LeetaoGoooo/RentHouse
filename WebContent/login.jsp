...
<div class="login-right">
	<div class="container">
		...
		<div class="login-top">
				<div class="form-info">
                <center>
                  <s:if test="%{#session.loginFail == 'loginFail'}" >
                  	<h2>帐号或密码错误！</h2>
                  </s:if>
				  <form action="userAction!userLogin" method="post">
						<input type="text" class="text" name="name" placeholder="帐号" required="">
			...
			<div class="create">
				<h4>一起找寻我们的家！</h4>
				<a class="hvr-sweep-to-right" href="register.html">加入我们吧！</a>
				<div class="clearfix"> </div>
			</div>
	</div>
</div>
