...
<div class="login-right">
	...
	<form action ="userAction!updateUserInfo" method="post">
		<h3>个人资料</h3>
		<div class="login-top">  
             <div class="col-loan">
                    <ul class="loan-col1">
               ...
               <ul class="loan-col1">
					...
					<li class="loan-list-top"><input type="text" name = "sex" value="${userinfo.getSex()}" placeholder="" required="" ></li>
				</ul>
    			<ul class="loan-col1">
					<li><span>手机号码</span></li><label>:</label>
					<li class="loan-list-top"><input type="text" name="phone" value="${userinfo.getPhone()}" placeholder="" required="" ></li>
				</ul>
				<ul class="loan-col1">
                <li><span>密码 </span></li><label>:</label>
                        <li class="loan-list-top"><input type="text" name="password" value="${userinfo.getPassword()}" placeholder="" required="" ></li>
                </ul>
                <ul class="loan-col1">
					<li><span>邮箱</span></li><label>:</label>
					<li class="loan-list-top"><input type="text" name="email" value="${userinfo.getEmail()}" placeholder="" required=""></li>
				</ul>
<%--                 <ul class="loan-col1">
                ...
                <br/>
				<div class="sub1">
					<center><label class="hvr-sweep-to-right"><input type="submit" value="保存" placeholder=""></label></center>
				</div>
			</div>
		</div>
	</form>
